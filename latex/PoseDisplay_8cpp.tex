...
\begin{DoxyCompactList}\small\item\em X11 \hyperlink{classError}{Error} Handler. Make X11 throw std\+::exception(), so that all errors can be handled the same way. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Distance from the beginning of the frame to the beginning of the view. \end{DoxyCompactList}\item 
